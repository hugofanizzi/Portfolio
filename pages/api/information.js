const information = [
  (aboutMeInformation = {
    ...
    summary: `¡Que bueno que has llegado hasta aquí!. Soy Hugo José Esparza Fanizzi, nacido en Venezuela, lleno de aspiraciones y metas por cumplir que seguro conseguire aqui en España. No creo en la palabra "No se puede" o  "No se hacerlo", pienso que ahora en el mundo que vivimos hay soluciones para todo y por eso me he querido sumergirme en la programación ya que es un mar de infinitas posibilidades. Me gusta mucho aprender cosas nuevas y me esmero por conseguir los objetivos que me propongo sin importar las veces que caiga seran mas las veces que me levantaré.`,
